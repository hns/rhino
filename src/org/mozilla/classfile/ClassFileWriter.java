...
import org.mozilla.javascript.ClassLimitException;
...
public class ClassFileWriter {
     ...
     * compiler.
     * @deprecated use {@link ClassLimitException} instead
     */
    @Deprecated
    ...
    public void add(int theOpCode, int theOperand) {
        ...
        switch (theOpCode) {
            ...
            case ByteCode.ASTORE :
                if (!(0 <= theOperand && theOperand < 65536))
                    throw new ClassLimitException("out of range variable");
                if (theOperand >= 256) {
    ...
    public void add(int theOpCode, int theOperand1, int theOperand2) {
        ...
        if (theOpCode == ByteCode.IINC) {
            ...
            if (!(0 <= theOperand2 && theOperand2 < 65536))
                throw new ClassLimitException("out of range increment");
    ...
    public int addTableSwitch(int low, int high)
    {
        ...
        if (low > high)
            throw new ClassLimitException("Bad bounds: "+low+' '+ high);
